...
\item \textbf{MCU \& SoC platforms}: ESP32 / ESP32-C3 (ESP-IDF), STM32 (CubeMX, HAL), NXP S32K144, ARM Cortex-M, Raspberry Pi 4/5, Orange Pi 5 (RK3588S), Rockchip RV1126, Allwinner V3s.
...
\begin{itemize}
    ...
    \item Designed a delta OTA pipeline over BLE with bootloader-managed boot selection: patch size reduced to 1.2\,KB, update completing in under 10\,s.
    ...
    \item Shipped end to end to sale under FCC compliance; DFM/DFA reduced cost by 30\%. Agile/Scrum, Jira, Git/GitHub CI/CD.
\end{itemize}
\vspace{2pt}
\textit{ROS2 Data Acquisition System -- embedded Linux, seat actuation and control}
\begin{itemize}
...
\vspace{1pt}
\begin{itemize}
\item{Co-inventor, three University of Michigan provisional patent applications, UM Ref. Nos. 2026-235-01, 2026-234-01, 2026-233-01 (2026).}
\end{itemize}
