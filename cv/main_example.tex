...
\needspace{5\baselineskip}
\item{\cventry{2024--2025}{University of Michigan (MDP, BIRDSlab)}{Mu-Roam -- Multi-legged Robots and Animal Motion}{}{}{\vspace{1pt}
\begin{itemize}
    \item Built ESP32 (ESP-IDF/FreeRTOS) quadcopter flight-control firmware: quaternion attitude estimation via a gyro and accelerometer complementary filter, stabilization and acro-mode flight, and ESC motor PWM output.
    \item Developed PID controllers for a multi-legged robot's leg joints (PWM, oscilloscope-verified) and a particle-filter state estimator fusing IMU and ToF-LiDAR; streamed motor-speed telemetry over UDP.
    \item Designed, simulated and debugged an over/under-voltage protection PCB in KiCAD and LTspice.
\end{itemize}}}
